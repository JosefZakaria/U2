        ...
        switch (button) {
            case Add:
              ...
              */
                ...
                String ageText = view.getAgeText();
                ...
                System.out.println("After firstName check, invalidInput: " + invalidInput);
                ...
                System.out.println("After lastName check, invalidInput: " + invalidInput);

               /* if (!ageText.matches("\\d+")){
                    System.out.println("Invalid age: " + ageText);
                    age = 0;
                    invalidInput = true;
                } else {
                ...
                if (!street.matches("[\\p{L}0-9\\s]+")){
                    System.out.println("Invalid street: " + street);
                    street = "Street";
                    invalidInput = true;
                }
                System.out.println("After street check, invalidInput: " + invalidInput);
                ...
                System.out.println("After city check, invalidInput: " + invalidInput);
                ...
                System.out.println("After zip code check, invalidInput: " + invalidInput);


                System.out.println("Final invalidInput value: " + invalidInput);

                if (invalidInput){
                    JOptionPane.showMessageDialog(null, "Input incorrect, try again!", "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                 ...
                 */
                register.addGuest(firstName, lastName, age, street, city, zipCode, country.toString());
                view.setNumGuest(Integer.toString(register.getNbrOfGuests()));
                view.updateGuestList(register.getInfoStrings());
                setDefaultValuesInView();
                break;
            ...
            case Change:
                ...
                if (validateIndex(index)) { //validateIndex is a private method in this class
                    ...
                    if (guestToChange != null){
                        ...
                        guestToChange.setCountry((Countries)view.getCountriesItem());
                        view.updateGuestList(register.getInfoStrings());
